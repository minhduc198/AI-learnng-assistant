    ...
    <div className="max-5-xl mx-auto">
      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8">
        <div className="text-center space-y-6">
          <div className="inline-flex justify-center items-center w-15 h-15 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 shadow-lg shadow-emerald-500/25">
            ...
            >
              <div className="flex items-center justify-between gap-4 mb-3">
                <div className="flex-1">
                  ...
                  <h4 className="text-base font-semibold text-slate-9 leading-relaxed">
                    {result.question}
                  </h4>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-2 px-3 py-1 bg-rose-100 border border-rose-300 rounded-lg text-xs font-semibold text-rose-700">
              ...
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/5- border border-slate-200 rounded-xl">
