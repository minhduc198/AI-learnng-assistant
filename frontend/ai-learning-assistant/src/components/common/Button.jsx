...
export default function Button({
  ...
  const variantStyles = {
    ...
    danger:
      "bg-red-500 hover:bg-red-600 active:bg-red-700 focus:ring-red-500 text-white/80 hover:text-white shadow-lg shadow-red-500/25 hover:shadow-xl hover:shadow-red-500/30",
  };
