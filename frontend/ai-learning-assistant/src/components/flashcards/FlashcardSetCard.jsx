...
export default function FlashcardSetCard({ flashcardSet }) {
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4">
          <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100">
            <BookOpen className="w-6 h-6 text-emerald-600" strokeWidth={2} />
          </div>

          <div className="flex-1 min-w-0">
            <h3
              className="text-base text-slate-900 font-semibold line-clamp-2 mb-1"
