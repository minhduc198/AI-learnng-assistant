        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-sm font-medium text-slate-700 rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
            >
              <ChevronLeft
        ...
        <div className="space-y-6 ">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              disabled={deleting}
              className="px-5 h-11 bg-linear-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-600 text-white font-medium text-sm rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {deleting ? (
